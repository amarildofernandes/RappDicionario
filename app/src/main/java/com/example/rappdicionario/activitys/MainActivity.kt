...
class MainActivity : AppCompatActivity() {
    ...
    private fun inserirPalavraC(palavraCViewModel: PalavraViewModel){
        ...
        val caminho_agricola  = "android.resource://com.example.rappdicionario/drawable/caminho_agricola" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/caminho_agricola_dois"

       palavraCViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"C", "Caminho Agrícola ou Florestal","Caminho público com acesso directo a um bloco de uma exploração agrícola ou florestal, que permite a circulação de veículos, máquinas e pessoas. Nota: uma servidão de passagem não é um caminho público.",caminho_agricola))

        val canhao  = "android.resource://com.example.rappdicionario/drawable/canhao" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/canhao_dois"

       palavraCViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"C", "Cereal","Nota: O termo CEREAL é reservado apenas para o grão comestível, não para a planta ou a cultura.",canhao))

        val cereal  = "android.resource://com.example.rappdicionario/drawable/cereal" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/cereal_dois"

       palavraCViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"C", "Cereal para a Produção de Grão","Ver Cultura Cerealífera para Produção de Grão",cereal))

        val charca  = "android.resource://com.example.rappdicionario/drawable/charca" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/charca_dois"

       palavraCViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"C", "Charca","Depressão ou escavação do solo, mais ou menos extensa, onde se acumula água pouco profunda de várias proveniências, que pode ser utilizada para rega.",charca))

        val chorrume  = "android.resource://com.example.rappdicionario/drawable/chorrume" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/chorrume_dois"

        palavraCViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"C", "Chorume","Mistura de excrementos e urina de animais domésticos que pode conter água e/ou uma pequena quantidade palha.",chorrume))

        val cobretura_de_plastico  = "android.resource://com.example.rappdicionario/drawable/cobretura_de_plastico" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/cobretura_de_plastico_dois"
       ...
       palavraCViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"C", "Cultura de Batata","1.\t1. Batata, incluindo batata primor e batata de semente (Solanum tuberosum L.)\n" +
        ...
        val curtura_beterraba_sacarina  = "android.resource://com.example.rappdicionario/drawable/curtura_beterraba_sacarina" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/curtura_beterraba_sacarina_dois"

        palavraCViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"C", "Cultura de Beterraba Sacarina","Beterraba sacarina, excluindo sementes, (Beta vulgaris L.), destinada à indústria do açúcar e à produção de álcool.",curtura_beterraba_sacarina))

        val cultura_de_cobertura  = "android.resource://com.example.rappdicionario/drawable/cultura_de_cobertura" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/cultura_de_cobertura_dois"
       ...
       palavraCViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"C", "Cultura Forrageira Sachada","1.\tCulturas forrageiras sachadas (excluindo sementes): Beterrabas forrageiras (Beta vulgaris L.) e plantas da família Brassicae destinadas a forragem, e outra plantas cultivadas principalmente pelas suas raízes, para forragem, diferentes das já indicadas. Nota: Todas as plantas da família Brassicae destinadas a forragem estão incluídas neste ponto, independentem do facto de se utilizar a raiz ou o caule para forragem. Entre outros, incluem-se, por exemplo, os topimambos (Helianthus tuberosus L.), a batata doce (Ipomoea batatas (L.) Lam.), a pastinaga forrageira (Pastinaca sativa L.), o (Discorea spp.) e a mandioca (Manihot esculenta Crantz).\n" +
        ...
        val cultura_horticula  = "android.resource://com.example.rappdicionario/drawable/cultura_horticula" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/cultura_horticula_dois"

        palavraCViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"C", "Cultura Hortícola","Inclui: Produtos hortícolas frescos, melões, tomate para indústria, Culturas ao ar livre e sob abrigo. Exclui: Cogumelos cultivados.",cultura_horticula))
       ...
       palavraCViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"C", "Cultura Industrial","Cultura de plantas industriais, i.e. plantas que não são, em geral, comercializadas directamente, uma vez que para a sua utilização final é necessário um processamento industrial prévio. Inclui: sementes de culturas oleaginosas herbáceas. Exclui: sementes e propágulos de culturas têxteis, lúpulo, tabaco e de outras culturas industriais. Exemplos:\n" +
        ...
        val cultura_irrigada  = "android.resource://com.example.rappdicionario/drawable/cultura_irrigada" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/cultura_irrigada_dois"
        ...
        val cultura_oleaginosa  = "android.resource://com.example.rappdicionario/drawable/cultura_oleaginosa" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/cultura_oleaginosa_dois"
    ...
    private fun inserirPalavraE(palavraEViewModel: PalavraViewModel){
        ...
        val estado_fenologico  = "android.resource://com.example.rappdicionario/drawable/estado_fenologico" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/estado_fenologico_dois"

        palavraEViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"E", "Estado Fenológico","Estádio de desenvolvimento das plantas detectável por alterações morfológicas.",estado_fenologico))
        ...
        val estufa  = "android.resource://com.example.rappdicionario/drawable/estufa" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/estufa_dois"


        palavraEViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"E", "Estufa","Estrutura fixa ou móvel, flexível ou rígida, em vidro, plástico ou outro material translúcido e impermeável à água, aquecida ou não, com a finalidade de alterar as condições climáticas no seu interior de modo a serem mais propícias ao desenvolvimento de uma cultura e dentro da qual uma pessoa pode trabalhar de pé e na vertical. Normalmente a estufa/abrigo alto é revestido a plástico só com arejamentos laterais e sem climatização. Considera-se a superfície total coberta pela estufa/abrigo alto, incluindo as passagens e o equipamento.",estufa))
    ...
    private fun inserirPalavraF(palavraFViewModel: PalavraViewModel){
        ...
        val fertirrigacao  = "android.resource://com.example.rappdicionario/drawable/fertirrigacao" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/fertirrigacao_dois"

        palavraFViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"F", "Fertirrigação","Prática cultural que se baseia na incorporação dos adubos químicos (fertirrigação mineral) ou dos escorrimentos provenientes das instalações pecuárias (fertirrigação orgânica) na água de rega.",fertirrigacao))
        ...
        val fungicida  = "android.resource://com.example.rappdicionario/drawable/fungicida" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/fungicida_dois"

        palavraFViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"F", "Fungicida","Substância ou preparação que destrói os fungos ou impede o seu desenvolvimento.",fungicida))

    }

    private fun inserirPalavraG(palavraGViewModel: PalavraViewModel){

        val galeria_ripicola  = "android.resource://com.example.rappdicionario/drawable/galeria_ripicola" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/galeria_ripicola_dois"

        palavraGViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"G", "Galeria Ripícola","Estrutura linear de composição arbóreo-arbustiva e herbácea própria de zonas húmidas, ao longo de linhas água, ocupando uma faixa de 5 metros para os lados de ambas as margens.",galeria_ripicola))

    }

    private fun inserirPalavraH(palavraHViewModel: PalavraViewModel){

        val herbicidas  = "android.resource://com.example.rappdicionario/drawable/herbicidas" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/herbicidas_dois"


        palavraHViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"H", "Herbicidas","Produtos químicos, que, pela sua variedade e poder seletivo, atuam nas ervas daninhas procurando não prejudicar o normal desenvolvimento das culturas.",herbicidas))
    ...
    private fun inserirPalavraI(palavraIViewModel: PalavraViewModel){
        ...
        val irrigacao  = "android.resource://com.example.rappdicionario/drawable/irrigacao" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/irrigacao_dois"
        ...
        val irrigacao_de_superficie  = "android.resource://com.example.rappdicionario/drawable/irrigacao_de_superficie" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/irrigacao_de_superficie_dois"
        ...
        palavraIViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"I", "Irrigação de Superfície","1.\tIrrigação de superfície (inundação, sulcos). O encaminhamento da água no solo, quer por inundação de toda a superfície quer por condução através de pequenos sulcos entre linhas de sementeira, recorrendo à gravidade como motor.\n" +
                "2.\tMétodo de rega em que a água é distribuída às parcelas, sem pressão, utilizando apenas o desnível existente e sem recurso a qualquer forma de energia.\n",irrigacao_de_superficie))

        val irrigacao_gota  = "android.resource://com.example.rappdicionario/drawable/irrigacao_gota" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/irrigacao_gota_dois"

        palavraIViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"I", "Irrigação Gota-a-Gota","Método de rega localizada em que a água é aplicada diretamente ao nível das raízes das plantas com débitos reduzidos (2 a 12 l/h) e baixa pressão, por intermédio de gotejadores.",irrigacao_gota))

        val irrigacao_localizada  = "android.resource://com.example.rappdicionario/drawable/irrigacao_localizada" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/irrigacao_localizada_dois"

        palavraIViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"I", "Irrigação Localizada","Método de rega que se caracteriza pela distribuição de pequenos débitos próximo do nível do solo, por intermédio de emissores (gotejadores, difusores, microaspersores) dispostos uniformemente ao longo de linhas de abastecimento, visando a economia de água dado que esta é aplicada directamente na zona radicular reduzindo assim as perdas. Este processo permite a incorporação e aplicação de fertilizantes às plantas através da água de rega.",irrigacao_localizada))

        val irrigacao_aspersao  = "android.resource://com.example.rappdicionario/drawable/irrigacao_aspersao" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/irrigacao_aspersao_dois"


        palavraIViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"I", "Irrigação por Aspersão","Método de rega no qual a água é distribuída uniformemente e com uma pressão apropriada sob a forma de chuva ao terreno através da utilização de diversos aparelhos (aspersores, canhões de rega).",irrigacao_aspersao))
    ...
    private fun inserirPalavraM(palavraMViewModel: PalavraViewModel){
        ...
        val matadouro  = "android.resource://com.example.rappdicionario/drawable/matadouro" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/matadouro_dois"

        palavraMViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"M", "Matadouro","Estabelecimento aprovado e licenciado pelas entidades competentes para a execução de abates e preparação das carcaças das espécies (bovina, ovina, caprina, suína , equina, aves , leitões e espécies abrangidas na designação caça de criação) destinados ao consumo público ou destinados à indústria.",matadouro))

        val matagal  = "android.resource://com.example.rappdicionario/drawable/matagal" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/matagal_dois"

        palavraMViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"M", "Matagal","Conjunto de arbustos arbóreos e arbustivos espontâneos presentes numa determinada área, que são geralmente ramosas desde a base e apresentam uma porção de caule lenhificada.",matagal))

        val mato  = "android.resource://com.example.rappdicionario/drawable/mato" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/mato_dois"

        palavraMViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"M", "Mato","Terras ocupadas com matos rasteiros, bouças, estevas e que de um modo geral são terras potencialmente cultiváveis.",mato))

        val mobilizacao_do_solo  = "android.resource://com.example.rappdicionario/drawable/mobilizacao_do_solo" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/mobilizacao_do_solo_dois"

        palavraMViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"M", "Mobilização do Solo","Passagem sobre o solo de máquinas automotrizes, rebocadas ou montadas na linha ou na entrelinha. Esta operação pode ter como objectivo a preparação do terreno para sementeiras, o combate a infestantes ou a criação de condições favoráveis à instalação e desenvolvimento das culturas.",mobilizacao_do_solo))
        ...
        val monda_mecanica  = "android.resource://com.example.rappdicionario/drawable/monda_mecanica" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/monda_mecanica_dois"

        palavraMViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"M", "Monda Mecânica","Processo utilizado para combater as infestantes das culturas ou ervas daninhas, através da utilização de alfaias agrícolas apropriadas, rebocadas ou montadas no trator, com mobilização do solo a maior ou menor profundidade.",monda_mecanica))
    ...
    private fun inserirPalavraP(palavraPViewModel: PalavraViewModel){
        ...
        val pastagem_permanente  = "android.resource://com.example.rappdicionario/drawable/pastagem_permanente" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/pastagem_permanente_dois"

        palavraPViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"P", "Pastagem Permanente Natural de Sequeiro","Ver Pastagem Permanente de Sequeiro",pastagem_permanente))
        ...
        val pomar  = "android.resource://com.example.rappdicionario/drawable/pomar" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/pomar_dois"

        palavraPViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"P", "Pomar","Povoamento regular de árvores de fruto, com uma densidade mínima de 100 árvores/ha. No caso do olival, figueiras e frutos secos, a densidade mínima é de 45 árvores/ha. Os povoamentos de pomoideas, prunoideas, soutos e de outras espécies “fruteiras”, estremes ou associadas, caso do amendoal e do figueiral, a densidade mínima é de 60 árvores/ha.",pomar))

        val pomar_amendoeiras  = "android.resource://com.example.rappdicionario/drawable/pomar_amendoeiras" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/pomar_amendoeiras_dois"
        ...
        val pomar_citrinos  = "android.resource://com.example.rappdicionario/drawable/pomar_citrinos" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/pomar_citrinos_dois"

        palavraPViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"P", "Pomar de Citrinos","Pomares de citrinos (Citrus spp.). Povoamento de uma ou mais espécies de citrinos cuja densidade seja superior a 40 árvores/ha",pomar_citrinos))
        ...
        val porta_enxerto  = "android.resource://com.example.rappdicionario/drawable/porta_enxerto" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/porta_enxerto_dois"

        palavraPViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"P", "Porta-Enxerto","Planta com raízes ou parte da planta enraizada (estaca) sobre a qual se procede a uma enxertia com um pedaço proveniente de outra planta de uma espécie ou variedade diferente (ex.: garfo, borbulha). O porta-enxerto pode ser designado também por cavalo. \n\nVer Propagação Vegetativa",porta_enxerto))

        val pousio  = "android.resource://com.example.rappdicionario/drawable/pousio" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/pousio_dois"
        ...
        val povoamento_quercineas  = "android.resource://com.example.rappdicionario/drawable/povoamento_quercineas" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/povoamento_quercineas_dois"


        palavraPViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"P", "Povoamento de Quercíneas ou Alfarrobeiras","Os povoamentos de montado, carvalhal ou pomares de alfarroba com densidades entre 21 e 40 arvores/ha.",povoamento_quercineas))


        val povoamento_florestal  = "android.resource://com.example.rappdicionario/drawable/povoamento_florestal" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/povoamento_florestal_dois"
    ...
    private fun inserirPalavraQ(palavraQViewModel: PalavraViewModel){
        ...
        val queimada  = "android.resource://com.example.rappdicionario/drawable/queimada" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/queimada_dois"

        palavraQViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"Q", "Queimada","O uso do fogo para a renovação das pastagens.",queimada))
    ...
    private fun inserirPalavraR(palavraRViewModel: PalavraViewModel){
        ...
        val rega_tradicional  = "android.resource://com.example.rappdicionario/drawable/rega_tradicional" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/rega_tradicional_dois"
    ...
    private fun inserirPalavraS(palavraSViewModel: PalavraViewModel){
        ...
        val sistema_drenagem  = "android.resource://com.example.rappdicionario/drawable/sistema_drenagem" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/sistema_drenagem_dois"

        palavraSViewModel.inserirPalavra(Palavra(UUID.randomUUID().toString(),"S", "Sistema de Drenagem","Sistema de valas, drenos subterrâneos, estações elevatórias ou obras similares, com que se assegura a evacuação das águas em excesso de uma determinada zona.",sistema_drenagem))
        ...
        val superficie_florestal  = "android.resource://com.example.rappdicionario/drawable/superficie_florestal" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/superficie_florestal_dois"
    ...
    private fun inserirPalavraV(palavraVViewModel: PalavraViewModel){
        ...
        val vinha  = "android.resource://com.example.rappdicionario/drawable/vinha" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/vinha_dois"
    ...
    private fun inserirPalavraZ(palavraZViewModel: PalavraViewModel){
        ...
        val zona_aravel  = "android.resource://com.example.rappdicionario/drawable/zona_aravel" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/zona_aravel_dois"
        ...
        val zona_montanha  = "android.resource://com.example.rappdicionario/drawable/zona_montanha" +
                "," +
                "android.resource://com.example.rappdicionario/drawable/zona_montanha"
